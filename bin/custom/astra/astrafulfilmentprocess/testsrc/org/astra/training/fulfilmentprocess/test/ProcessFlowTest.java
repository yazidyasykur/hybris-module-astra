 ...
 */
package org.astra.training.fulfilmentprocess.test;
...
import org.astra.training.fulfilmentprocess.test.actions.TestActionTemp;
...
public class ProcessFlowTest extends HybrisJUnit4Test
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/astrafulfilmentprocess/test/astrafulfilmentprocess-spring-test.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/astrafulfilmentprocess/test/process/order-process-spring.xml"));
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/astrafulfilmentprocess/test/process/consignment-process-spring.xml"));
		...
		definitonFactory.add("classpath:/astrafulfilmentprocess/test/process/order-process.xml");
		definitonFactory.add("classpath:/astrafulfilmentprocess/test/process/consignment-process.xml");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/astrafulfilmentprocess/test/astrafulfilmentprocess-spring-testcleanup.xml"));
