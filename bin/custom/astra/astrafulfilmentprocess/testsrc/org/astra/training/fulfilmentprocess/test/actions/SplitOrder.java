 ...
 */
package org.astra.training.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(AstraFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AstraFulfilmentProcessConstants.PARENT_PROCESS);
