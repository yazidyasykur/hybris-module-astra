 ...
 */
package org.astra.training.storefront.security.impl;
...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/astrastorefront/electronics/en",
						"https://electronics.local:9002/astrastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/astrastorefront/electronics/en",
						"https://electronics.local:9002/astrastorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/astrastorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/astrastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/astrastorefront/electronics/en",
						"https://electronics.local:9002/astrastorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/astrastorefront",
						"https://electronics.local:9002/astrastorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/astrastorefront",
						"https://electronics.local:9002/astrastorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/astrastorefront/electronics/en",
						"https://electronics.local:9002/astrastorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
